...
# End-to-end runner for the apple_silicon_tracknet demo.
#
# Prereqs (one-shot):
...
#
# Usage:
#   bash scripts/macos/run-apple-silicon-tracknet.sh /path/to/video.mp4 [/path/to/out.mp4]
#
...
RESULT_MP4="${2:-${RESULT_MP4:-/tmp/apple_silicon_tracknet_result.mp4}}"
...
GRAPH="${INSTALL_PREFIX}/usr/local/share/modelbox/demo/apple_silicon_yolo/graph/apple_silicon_tracknet.toml"
...
s = s.replace('default_dest_url="/tmp/apple_silicon_tracknet_result.mp4"',

...
#ifndef MODELBOX_FLOWUNIT_VIDEO_DECODER_INTEL_GPU_H_
#define MODELBOX_FLOWUNIT_VIDEO_DECODER_INTEL_GPU_H_
...
constexpr const char *FLOWUNIT_DESC =
    "\n\t@Brief: A video decoder on Intel GPU (Arc) via QSV / VAAPI. \n"
...
#endif  // MODELBOX_FLOWUNIT_VIDEO_DECODER_INTEL_GPU_H_

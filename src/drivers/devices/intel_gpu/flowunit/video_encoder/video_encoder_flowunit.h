...
#ifndef MODELBOX_FLOWUNIT_VIDEO_ENCODER_INTEL_GPU_H_
#define MODELBOX_FLOWUNIT_VIDEO_ENCODER_INTEL_GPU_H_
...
constexpr const char *FLOWUNIT_DESC =
    "\n\t@Brief: A video encoder on Intel GPU (Arc) via QSV. \n"
...
#endif  // MODELBOX_FLOWUNIT_VIDEO_ENCODER_INTEL_GPU_H_

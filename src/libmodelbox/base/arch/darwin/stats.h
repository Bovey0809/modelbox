...
class DarwinOSProcess : public OSProcess {
 public:
  DarwinOSProcess();
  ~DarwinOSProcess() override;
...
class DarwinOSThread : public OSThread {
 public:
  DarwinOSThread();
  ~DarwinOSThread() override;
...
class DarwinOSInfo : public OSInfo {
 public:
  DarwinOSInfo();
  ~DarwinOSInfo() override;
  ...
  static DarwinOSInfo &GetInstance();
};
